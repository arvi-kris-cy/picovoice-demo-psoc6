...
```bash
python3 binary_to_c_array.py input_binary_model output_c_array.txt  # Linux, MacOS
python binary_to_c_array.py input_binary_model output_c_array.txt  # Windows
```
